...
const formatRows = (likedCoins: string[], coins: CoinCapURIResponse[], displayAll: boolean): GridRowsProp => {
    ...
    return (
        <div style={{ display: 'flex', height: '100%' }} className={classes.root}>
            <div style={{ flexGrow: 1 }}>
                <DataGrid autoHeight rows={formatRows(likedCoins, coins, displayAllItems)} columns={columns} />
            </div>
        </div>
    );
};
